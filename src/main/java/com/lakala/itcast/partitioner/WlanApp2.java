package com.lakala.itcast.partitioner;
 ...
 * 分区函数.
 * 
 * 有什么作用？用来对输出数据进行分文件存放的。
 * 怎么用？
 * 
 * 1.继承Partitioner类，覆盖其中的getPartitions方法
 * 2.在Job中，setPartitionerClass(...)，同时setNumReduceTasks(...)
 */
public class WlanApp2 {
	public static final String HADOOP_URL = "hdfs://10.5.12.66:9000";
	public static final String INPUT_URL = "/partitioninput";
	public static final String OUTPUT_URL = "/partitionoutput";
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(WlanApp2.class);
	...
	static class MyReducer extends Reducer<Text, KpiWritable, Text, KpiWritable> {
		...
		protected void reduce(Text k2, java.lang.Iterable<KpiWritable> v2s,
			...
			ctx.write(k2, new KpiWritable(upPackNum + "", downPackNum + "", upPayLoad + "", downPayLoad + ""));
		};
	}

}

class MyPartitioner extends Partitioner<Text, KpiWritable> {
	@Override
	public int getPartition(Text k2, KpiWritable v2, int numReduceTasks) {
		return k2.toString().length() == 11 ? 0 : 1;
	}
}

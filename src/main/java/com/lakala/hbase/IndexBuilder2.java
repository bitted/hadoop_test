 ...
 * <ul>
 * <li>Using TableInputFormat and TableMapReduceUtil to use an HTable as input to a map/reduce job.</li>
 ...
 * 
 * <p>
 * Modify ${HADOOP_HOME}/conf/hadoop-env.sh to include the hbase jar, the zookeeper jar, the examples output directory, and the
 * hbase conf directory in HADOOP_CLASSPATH, and then run
 * <tt><strong>bin/hadoop org.apache.hadoop.hbase.mapreduce.IndexBuilder TABLE_NAME COLUMN_FAMILY ATTR [ATTR ...]</strong></tt>
 * </p>
 * 
 * <p>
 * To run with the sample data provided in index-builder-setup.rb, use the arguments <strong>
 * <tt>people attributes name email phone</tt></strong>.
 * </p>
 * 
 * <p>
